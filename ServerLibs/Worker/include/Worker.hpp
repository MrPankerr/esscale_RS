#ifndef _LIBRARY_WORKER_H_
#define _LIBRARY_WORKER_H_
...
enum MYLIB_EXPORT Packet_Worker{
	P_ChatMessege_W,
	P_Closed_W
};

//the function of defining and executing instructions corresponding to this package
MYLIB_EXPORT bool ProcessPacket(int, Packet_Worker, int, SOCKET*);

#endif /* _LIBRARY_WORKER_H_ */